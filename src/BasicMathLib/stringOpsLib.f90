...
implicit none
	...
	public:: lowerStringFc, upperStringFc
    public:: i2s
...
contains
	...
	!--
    elemental function lowerStringFc(str) result(s)
	...
	!--
    elemental function upperStringFc(str) result(s)
    character(*),intent(in)::	str
	character(len(str))::		s
